...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;"><a id="edit" href="javascript:;" class="easyui-linkbutton" >修改</a></div>
			<div style="float: left;" class="datagrid-btn-separator"></div>
		<div><a id="delete" href="javascript:;" class="easyui-linkbutton" >删除</a></div>
	</div>
    	...
    	<form id="editForm" method="post">
	    	<table id="editTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6" >
	    		<tr>
	    			...
	    			<td colspan="3"><input id="edit_number" data-options="readonly: false" class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="number" data-options="required:true, validType:'repeat', missingMessage:'请输入工号'" /></td>
	    			<td style="width:80px"></td>
	    		</tr>
	    		<tr>
	    			<td>姓名:</td>
