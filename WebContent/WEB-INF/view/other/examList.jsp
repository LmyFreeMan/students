            	...
            	if(exam.type == 1){
            		$("#regClazzList").combobox("readonly", false);
               		...
               		setTimeout(function(){
                		...
                		var data = {id: exam.id, gradeid: exam.gradeid, clazzid:exam.clazzid, courseid:exam.courseid, type: '1'};
                		//动态显示该次考试的科目
    	            	$.ajax({
    	            		type: "post",
    						url: "ScoreServlet?method=ColumnList",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;"><a id="delete" href="javascript:;" class="easyui-linkbutton" >删除</a></div>
			<div style="float: left;" class="datagrid-btn-separator"></div>
				<div style="float: left;"><a id="register" href="javascript:;" class="easyui-linkbutton" >登记成绩</a></div>
		
		<div style="float: left;"><a id="escore" href="javascript:;" class="easyui-linkbutton" >成绩统计</a></div>
	...
	<div id="escoreToolbar">
		<a id="redo" href="javascript:;" class="easyui-linkbutton" >导出</a>
	...
	<div id="regEscoreToolbar">
		<a id="regiser" href="javascript:;" class="easyui-linkbutton" >提交</a>
		<a id="clear" href="javascript:;" class="easyui-linkbutton" >清空</a>
