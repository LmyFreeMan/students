    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"","menuname":"教学管理",
							"menus":[
									{"menuid":"11","menuname":"成绩查询","url":"StudentServlet?method=toExamStudentView"},
								]
						},
						
						{"menuid":"3","icon":"","menuname":"系统管理",
							"menus":[
							        {"menuid":"31","menuname":"个人信息","url":"StudentServlet?method=toStudentPersonalView"},
								]
						}
				]};
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">学生端|学生成绩管理系统</span>
    </div>
